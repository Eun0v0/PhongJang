...
<div id="naver_common_editor">
  ...
  <div class="pic_content" style="border:0;">
    ...
    <div class="btn_box">
      <a href="javascript:submitImageUploadForm(document.getElementById('editor_upimage'));"><img src="/smarteditor/img/btn_layer_confirm.gif" alt="확인" width="38" height="21" border="0"></a>
